...
interface EditProfileClientPageProps {
  locale: string;
  initialUserData: EditableUserData;
}
...
export default function EditProfileClientPage({
  ...
  const [previewUrl, setPreviewUrl] = useState<string | null>(
    getFullAvatarUrl(initialUserData.avatar_photo)
  );
  ...
  const [userData] = useState<EditableUserData>(initialUserData);
